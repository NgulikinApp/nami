...
var ASKING_API = INIT_URL + "/asking",
    ...
    NOTIFICATION_API = INIT_URL +  "/notif",
    PRODUCT_API = INIT_URL + "/product",
    PROFILE_API = INIT_URL + "/profile",
...
var SHOP_DISCUSS_API = SHOP_API + "/discuss",
    SHOP_DISCUSS_COMMENT_API = SHOP_DISCUSS_API + "/c",
    ...
    SHOP_REVIEW_COMMENT_API = SHOP_REVIEW_API + "/c";