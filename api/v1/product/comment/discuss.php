        ...
        */
        ...
        try{
            ...
            */
            ...
            $stmt = $con->prepare("INSERT INTO product_discuss(product_id,user_id,product_discuss_comment) VALUES(?,?,?)");
               
            $stmt->bind_param("iss", $id,$user_id,$comment);
            
            $stmt->execute();
            
            $product_discuss_id = $con->insert_id;
            
            $stmt = $con->prepare("UPDATE product SET product_total_discuss=product_total_discuss+1 where product_id=?");
            ...
            $stmt->bind_param("i", $product_discuss_id);
            
            comment($stmt,$product_discuss_id,$id,$user_id,$comment,$user_photo,$username);
        }catch(Exception $e){
            /*
                Function location in : /model/general/functions.php
            */
