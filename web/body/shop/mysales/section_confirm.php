            ...
            <div class="rightCont" style="vertical-align: top;margin-top: 20px;">
                <div class="grid">
                    <div class="detail">
                        ...
                        <div class="body" id="phoneConfirmMysales">9999 999 999</div>
                    </div>
                </div>
                <div class="grid proof">
                    <div id="proofConfirmMysales">
                ...
                <div class="grid">
                     <div class="detail confirm">
                        <div class="body" id="totalpricetextMySales">Total Harga</div>
                    </div>
                    <div class="detail confirm">
                        <div class="head"></div>
                        <div class="body" id="totalpriceMySales">Harga : Rp 9.000</div>
                    </div>
                </div>
            </div>
        </div>
