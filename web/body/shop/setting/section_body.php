<div class="home_container">
	<section class="container shop-seller">
	    ...
	    <div class="grid-shop-seller-menu">
	        <nav>
	            <a>
	                <div id="profile-shop-seller" class="bluesky border-yellow">Profile Toko</div>
	            </a>
	            <a>
	    ...
	    <div class="grid-shop-seller-body">
	        <div id="profile-shop-seller-content" class="grid-shop-seller-content">
	            <?php include 'section_profile.php';?>
	        </div>
