<div class="list-search active" id="list-search-product">
    <div class="result-content-list">
        <div class="result-content-list-data" datainternal-id="kuliner~87676786668">
    ...
    <div class="result-content-paging">
        <ul class="pagination" id="pagingSearchProduct"></ul>
    </div>
</div>