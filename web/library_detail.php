<?php include 'system/minify.php';?>
<?php include 'system/crossFrame.php';?>
<?php include 'system/checkDevice.php';?>
<?php include 'system/getUrl.php';?>
<?php include 'system/jsversionstring.php';?>
...
<link href="../../css/sidebar.css?jsr=<?php echo $jsversionstring; ?>" rel="stylesheet">
...
<script src="../../js/library/jquery-ui-1.12.1.js?jsr=<?php echo $jsversionstring; ?>"></script>
<script src="../../js/library/jssor.slider-22.2.8.min.js?jsr=<?php echo $jsversionstring; ?>"></script>
<script src="../../js/library/jquery-jssorslider.js?jsr=<?php echo $jsversionstring; ?>"></script>
<script src="../../js/library/datepicker.js?jsr=<?php echo $jsversionstring; ?>"></script>
<script src="../../js/library/velocity.min.js?jsr=<?php echo $jsversionstring; ?>"></script>
<script src="../../js/library/modernizr.js?jsr=<?php echo $jsversionstring; ?>"></script>
<script src="../../js/library/velocity.ui.min.js?jsr=<?php echo $jsversionstring; ?>"></script>
<script src="../../js/library/webtoolkit.sha256.js?jsr=<?php echo $jsversionstring; ?>"></script>
<script src="../../js/library/jquery.lightbox-0.5.min.js?jsr=<?php echo $jsversionstring; ?>"></script>
